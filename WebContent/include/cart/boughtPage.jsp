                        ...
                        <c:if test="${st.count==1}">
                            ...
                            <td rowspan="${fn:length(o.orderItems)}" class="orderListItemButtonTD orderItemOrderInfoPartTD" width="100px">
                                <c:if test="${o.status=='waitConfirm' }">
                                    <a href="fore_confirmPay?oid=${o.id}">
                            ...
                            <td class="orderListItemButtonTD orderItemOrderInfoPartTD">               
                                <c:if test="${o.status=='waitReview' }">
                                    <a href="fore_review?pid=${oi.product.id}&oid=${o.id}">
                                        <button  class="orderListItemReview">评价</button>
                                    </a>
                                </c:if>
                                <c:if test="${o.status!='waitReview'}">
									<span>订单尚<br>未完成</span>
                                </c:if>
                            </td>
                    </tr>
                </c:forEach>     
