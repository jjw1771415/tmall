...
<div class="confirmPayPageDiv">
	...
	<div class="confirmPayOrderItemDiv">
				...
				<tr>
					...
					<td>
						<span class="conformPayProductPrice">
							￥<fmt:formatNumber value="${oi.product.promotePrice}" minFractionDigits="2" type="number"></fmt:formatNumber>
						</span>
					</td>
		...
		<div class="confirmPayOrderItemText pull-right">
			实付款：<span class="confirmPayOrderItemSumPrice">￥<fmt:formatNumber type="number" minFractionDigits="2" value="${o.total}"></fmt:formatNumber></span>
		</div>
	</div>
	
	<div class="confirmPayOrderDetailDiv">
		<table class="confirmPayOrderDetailDiv">
			<tr>
				<td>订单编号：</td>
				<td>${o.orderCode}<img src="img/site/confirmOrderTmall.png" width="23px">
			</tr>
			<tr>
				<td>卖家昵称：</td>
	...
	<div class="confirmPayButtonDiv">
		...
		<a href="fore_orderConfirmed?oid=${o.id}"><button class="confirmPayButton">确认支付</button></a>
	</div>
