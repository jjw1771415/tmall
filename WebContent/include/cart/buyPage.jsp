  ...
  <form action="fore_createOrder" method="post">
    ...
    <div class="productList">
            ...
            <tbody class="productListTableTbody">
            	<c:forEach items="${ois}" var="oi" varStatus="st">
            		<tr class="orderItemTR">
            			...
            			<td class="oderItemProductInfo">
	            			<a class="orderItemProductLink" href="fore_product?pid=${oi.product.id}">
	            				${oi.product.name}
	            			</a>
						...
						<td rowspan="5" class="ordertItemLastTD">
 	...
 	<span class="leaveMessageTextareaSpan">
                <textarea name="userMessage" class="leaveMessageTextarea" placeholder="还可以输入200个字符"></textarea>
            </span>
